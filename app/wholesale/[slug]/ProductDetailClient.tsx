        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              <h1 className="text-display-lg font-serif text-charcoal mb-3">{product.name}</h1>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="p-3 bg-offwhite">
                <p className="text-[10px] uppercase tracking-wider text-muted mb-1">Fit</p>
                <p className="text-sm font-medium text-charcoal">{product.fit}</p>
              </div>
              <div className="p-3 bg-offwhite">
                <p className="text-[10px] uppercase tracking-wider text-muted mb-1">MOQ</p>
      ...
      <section className="py-16 section-padding bg-cream">
        <div className="max-w-7xl mx-auto grid sm:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="text-[11px] text-muted mt-1">Low minimum order quantity per color/size</p>
          </div>
          <div>
        ...
        <section className="py-20 section-padding bg-cream">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {[
                "/images/products/240g-vintage-crop/detail/detail-06.webp",
                "/images/products/240g-vintage-crop/detail/detail-08.webp",
                "/images/products/240g-vintage-crop/detail/detail-09.webp",
                "/images/products/240g-vintage-crop/detail/detail-17.webp",
                "/images/products/240g-vintage-crop/detail/detail-18.webp",
              ].map((img) => (
