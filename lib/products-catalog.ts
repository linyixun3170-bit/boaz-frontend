...
export const products: Product[] = [
  ...
  {
    id: "xsl-260g-sorona",
    name: "260gsm Sorona Open Shoulder T-Shirt",
    slug: "xsl-260g-sorona",
    tagline: "Sorona® bi-component fiber — soft, stretchy, and sustainably renewable",
    category: "T-Shirts",
    weight: "260gsm",
    fabric: "Sorona® (Bi-Component Renewable Fiber)",
    ...
    images: {
      main: `${imgBase}/xsl-260g-sorona/model/image_1772611126540.webp`,
      gallery: [
        `${imgBase}/xsl-260g-sorona/model/image_1772611126540.webp`,
        `${imgBase}/xsl-260g-sorona/model/image_1772611157644.webp`,
        `${imgBase}/xsl-260g-sorona/model/image_1772611172988.webp`,
        `${imgBase}/xsl-260g-sorona/model/image_1772611180149.webp`,
        `${imgBase}/xsl-260g-sorona/model/image_1772611188228.webp`,
        `${imgBase}/xsl-260g-sorona/model/image_1772611194379.webp`,
        `${imgBase}/xsl-260g-sorona/model/image_1772611200892.webp`,
        `${imgBase}/xsl-260g-sorona/model/image_1772611208291.webp`,
        `${imgBase}/xsl-260g-sorona/flat/flat-01.webp`,
        `${imgBase}/xsl-260g-sorona/flat/flat-02.webp`,
        `${imgBase}/xsl-260g-sorona/flat-back/flat-back-01.webp`,
      ],
    },
    tags: ["Sorona", "Eco-Friendly", "Drop Shoulder", "10 Colors", "Renewable Fiber"],
    sizes: ["S", "M", "L", "XL", "2XL"],
    isNew: true,
  },
  {
    id: "cl-sunscreen-vintage",
    name: "230gsm Cotton Sun Protection Vintage T-Shirt",
    slug: "cl-sunscreen-vintage",
    tagline: "Vintage washed short sleeve with sun protection — soft, breathable, and UV-resistant",
    category: "T-Shirts",
    weight: "230gsm",
    fabric: "100% Cotton (Vintage Washed, UV-Resistant Finish)",
    ...
    images: {
      main: `${imgBase}/cl-sunscreen-vintage/model/model-1.webp`,
      gallery: [
        `${imgBase}/cl-sunscreen-vintage/model/model-1.webp`,
        `${imgBase}/cl-sunscreen-vintage/model/model-2.webp`,
        `${imgBase}/cl-sunscreen-vintage/model/model-3.webp`,
        `${imgBase}/cl-sunscreen-vintage/model/model-4.webp`,
        `${imgBase}/cl-sunscreen-vintage/model/model-5.webp`,
        `${imgBase}/cl-sunscreen-vintage/model/model-6.webp`,
        `${imgBase}/cl-sunscreen-vintage/model/model-7.webp`,
        `${imgBase}/cl-sunscreen-vintage/model/detail-1.webp`,
      ],
    },
    tags: ["Sun Protection", "Vintage Wash", "UV-Resistant", "Short Sleeve", "7 Colors"],
    sizes: ["S", "M", "L", "XL", "2XL", "3XL", "4XL", "5XL"],
    isNew: true,
  },
  {
    id: "cl-longsleeve-vintage",
    name: "230gsm Cotton Vintage Washed Long Sleeve T-Shirt",
    slug: "cl-longsleeve-vintage",
    tagline: "Pre-washed vintage drop shoulder long sleeve — soft, relaxed, and broken in",
    ...
    images: {
      main: `${imgBase}/cl-longsleeve-vintage/model/image_1769572597624.webp`,
      gallery: [
        `${imgBase}/cl-longsleeve-vintage/model/image_1769572597624.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/image_1769572615231.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/image_1769572621424.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/image_1769572628800.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/image_1769572635768.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/image_1769572645040.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/image_1769572652616.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/detail-collage.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/detail-extra.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/sku-1.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/sku-2.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/sku-3.webp`,
        `${imgBase}/cl-longsleeve-vintage/model/sku-4.webp`,
      ],
    },
    tags: ["Long Sleeve", "Vintage Wash", "Drop Shoulder", "Relaxed Fit", "5 Colors"],
    sizes: ["S", "M", "L", "XL", "2XL"],
    isNew: true,
  },
  {
  ...
  {
    id: "cl-washed-vintage-set",
    name: "Washed Vintage Sleeveless Set (T-Shirt + Tank + Shorts)",
    slug: "cl-washed-vintage-set",
    tagline: "Matching 3-piece set — 220gsm washed cotton tee, tank & shorts, mix & match",
    category: "T-Shirts",
    weight: "220gsm",
    fabric: "100% Cotton (Washed Vintage)",
    ...
    images: {
      ...
      gallery: [
        ...
        `${imgBase}/cl-washed-vintage-set/sku/sku-Gray-tank-back.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Gray-shorts.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Gray-shorts-back.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Green-tee.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Green-tee-back.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Green-tank.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Green-tank-back.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Green-shorts.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Green-shorts-back.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Black-tee.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Black-tee-back.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Black-tank.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Black-tank-back.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Black-shorts.webp`,
        `${imgBase}/cl-washed-vintage-set/sku/sku-Black-shorts-back.webp`,
      ],
    },
    tags: ["Washed", "Vintage", "Set", "T-Shirt", "Tank Top", "Shorts", "Matching", "3 Colors"],
    sizes: ["S", "M", "L", "XL", "2XL"],
    sizeChart: [
      { label: "Shoulder", valuesCm: { "S": "48", "M": "50", "L": "52", "XL": "54", "2XL": "56" } },
      { label: "Chest", valuesCm: { "S": "50", "M": "52", "L": "54", "XL": "56", "2XL": "58" } },
      { label: "Length", valuesCm: { "S": "66", "M": "68", "L": "70", "XL": "72", "2XL": "74" } },
    ],
    isNew: true,
  },
];
