...
export const products: Product[] = [
  {
    ...
    colors: [
      { name: "White", hex: "#ffffff", image: `${imgBase}/280g-heavy-tee/sku-12-white.jpg` },
      { name: "Black", hex: "#111111", image: `${imgBase}/280g-heavy-tee/sku-11-black.jpg` },
      { name: "Navy", hex: "#1a2744", image: `${imgBase}/280g-heavy-tee/sku-5-royal-blue色.jpg` },
      { name: "Dark Gray", hex: "#555555", image: `${imgBase}/280g-heavy-tee/sku-6-dark-gray.jpg` },
      { name: "Charcoal", hex: "#36454f", image: `${imgBase}/280g-heavy-tee/sku-7-灰black.jpg` },
      { name: "Khaki", hex: "#c3b091", image: `${imgBase}/280g-heavy-tee/sku-1-light-coffee.jpg` },
      { name: "Cream", hex: "#f5f0e8", image: `${imgBase}/280g-heavy-tee/sku-13-cream-beige.jpg` },
      { name: "Wine Red", hex: "#722f37", image: `${imgBase}/280g-heavy-tee/sku-10-酒红色.jpg` },
      { name: "Army Green", hex: "#4b5320", image: `${imgBase}/280g-heavy-tee/sku-21-forest-green.jpg` },
      { name: "Royal Blue", hex: "#4169e1", image: `${imgBase}/280g-heavy-tee/sku-5-royal-blue色.jpg` },
    ],
    images: {
  ...
  },
  {
    ...
    colors: [
            { name: "Black", hex: "#111111", image: `${imgBase}/360g-crewneck/sku-1-black.jpg` },
      { name: "Gray", hex: "#808080", image: `${imgBase}/360g-crewneck/sku-3-gray.jpg` },
      { name: "Dark Gray", hex: "#555555", image: `${imgBase}/360g-crewneck/sku-5-dark-gray.jpg` },
      { name: "Coffee", hex: "#6f4e37", image: `${imgBase}/360g-crewneck/sku-4-coffee.jpg` },
      { name: "Army Green", hex: "#4b5320", image: `${imgBase}/360g-crewneck/sku-6-dark-green色.jpg` },
    ],
    images: {
  ...
  },
  {
    ...
    colors: [
            { name: "White", hex: "#ffffff", image: `${imgBase}/260g-heavy-tee/sku-1-white.jpg` },
      { name: "Black", hex: "#111111", image: `${imgBase}/260g-heavy-tee/sku-2-black.jpg` },
      { name: "Carbon Gray", hex: "#808080", image: `${imgBase}/260g-heavy-tee/sku-3-carbon-gray.jpg` },
      { name: "Navy", hex: "#1a2744", image: `${imgBase}/260g-heavy-tee/sku-4-navy.jpg` },
      { name: "Brick Red", hex: "#cb4154", image: `${imgBase}/260g-heavy-tee/sku-5-brick-red.jpg` },
      { name: "Khaki", hex: "#c3b091", image: `${imgBase}/260g-heavy-tee/sku-6-khaki.jpg` },
      { name: "Sage Green", hex: "#88b04b", image: `${imgBase}/260g-heavy-tee/sku-7-sage-green.jpg` },
      { name: "Cream", hex: "#f5f0e8", image: `${imgBase}/260g-heavy-tee/sku-8-cream.jpg` },
    ],
    images: {
  ...
  },
  {
    ...
    colors: [
            { name: "White", hex: "#ffffff", image: `${imgBase}/220g-heavy-tee/sku-1-white.jpg` },
      { name: "Black", hex: "#111111", image: `${imgBase}/220g-heavy-tee/sku-4-black.jpg` },
      { name: "Light Gray", hex: "#d3d3d3", image: `${imgBase}/220g-heavy-tee/sku-8-light-gray.jpg` },
      { name: "Dark Gray", hex: "#555555", image: `${imgBase}/220g-heavy-tee/sku-9-dark-gray.jpg` },
      { name: "Blue", hex: "#4169e1", image: `${imgBase}/220g-heavy-tee/sku-6-royal-blue色.jpg` },
    ],
    images: {
