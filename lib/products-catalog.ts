...
export const products: Product[] = [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Brick Red", hex: "#cb4154", image: `${imgBase}/240g-vintage-crop/front-brick.jpg` },
      { name: "Sage", hex: "#88b04b", image: `${imgBase}/240g-vintage-crop/front-sage.jpg` },
      { name: "Cream", hex: "#f5f0e8", image: `${imgBase}/240g-vintage-crop/front-cropped-1.jpg` },
      { name: "Light Blue", hex: "#8db6ce", image: `${imgBase}/240g-vintage-crop/front-cropped-2.jpg` },
    ...
    images: {
      ...
      gallery: [
        ...
        `${imgBase}/240g-vintage-crop/size-chart-en.jpg`,
      ],
    },
